...
const services = [
  ...
  },
  {
    icon: Sparkles,
    title: 'AI Agent 智能',
    description: 'Take the power of generative AI a step further by working alongside you or even on your behalf',
    gradient: 'from-green-600 to-yellow-600'
  },
  {
    icon: Code,
    title: 'Development 開發',
  ...
  return (
    <section ref={ref} id="services" className="py-32 bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Our Expertise 專長</h2>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Comprehensive solutions that transform ideas into impactful digital experiences. 輔助小型企業AI智能化轉型
          </p>
        </motion.div>
