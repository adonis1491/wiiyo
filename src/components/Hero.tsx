  ...
  return (
    <div className="relative min-h-screen flex items-center overflow-hidden">
      ...
      >
        ...
        <motion.div
          className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1716637644831-e046c73be197?q=80&w=1587&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D?auto=format&fit=crop&q=80')] bg-cover bg-center"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="max-w-4xl">
          ...
          >
            ...
            and strategic thinking that drives high CVR. 歡迎洽詢AI轉型專家
          </motion.p>
